...
- (void)testNewsFeedInitializer
{
    ...
    NSArray <Row> *array = [(NSArray <Row> *) [[NSArray alloc] initWithObjects:row, nil] autorelease];

    NewsFeed *feed = [[[NewsFeed alloc] initWithTitle:titleFeed rows:array] autorelease];
...
- (void)testRowFromJSONString
{
    ...
    NewsFeed *feed = [[NewsFeed fromJSONString:original] autorelease];
